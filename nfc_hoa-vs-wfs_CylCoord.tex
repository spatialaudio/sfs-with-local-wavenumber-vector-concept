...
\fsd \theta
\end{align}
So, the Fourier series of the second exp-function would be
\begin{align}
\int_0^{2\pi}
\mathrm{e}^{-\mathrm{j}[(\phi_0-\phi_{PW})+\frac{\omega}{c} r_0
\cos(\phi_0-\phi_{PW})]}
...
\end{align}
with $n_-=m-1$, $n_+=m+1$ and $z=\frac{\omega}{c} r_0 $ 
\begin{align}
\frac{1}{2}
\e^{- \im m \phi_{PW}}
[
\int_0^{2\pi} \mathrm{e}^{-\mathrm{j}[n_-\theta+z \cos\theta]} \fsd \theta+
\int_0^{2\pi} \mathrm{e}^{-\mathrm{j}[n_+\theta+z \cos\theta]} \fsd \theta
]
\end{align}
with $n_-=-(m-1)$, $n_+=-(m+1)$ and $z=-\frac{\omega}{c} r_0 $ 
...
\e^{- \im m \phi_{PW}}
[
\int_0^{2\pi} \mathrm{e}^{\mathrm{j} n_-\theta}\mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta+
\int_0^{2\pi} \mathrm{e}^{\mathrm{j} n_+\theta}\mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta
]
\end{align}
\begin{align}
...
\e^{- \im m \phi_{PW}}
[
\int_0^{2\pi} (\cos(n_-\theta)+\im \sin(n_-\theta)) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta+
\int_0^{2\pi} (\cos(n_+\theta)+\im \sin(n_+\theta)) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta
]
\end{align}
For the first cosine we have
\begin{align}
\int_0^{2\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta =
\int_0^{\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta  + 
\int_\pi^{2\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta 
\end{align}
unsure about that, but we might rearrange pi to 2pi int
\begin{align}
\int_0^{2\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta =
\int_0^{\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta  + 
\int_0^{\pi} -\cos(n_-\theta) \mathrm{e}^{-\mathrm{j} z \cos\theta} \fsd \theta 
\end{align}
Then with NIST 10.9.2
\begin{align}
\int_0^{2\pi} \cos(n_-\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta =
J_{n_-}(z) \frac{\pi}{\im^{-n_-}} - J_{n_-}(-z) \frac{\pi}{\im^{-n_-}}
\end{align}
For the second cosine we have similarly
\begin{align}
\int_0^{2\pi} \cos(n_+\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta = 
\int_0^{\pi} \cos(n_+\theta) \mathrm{e}^{\mathrm{j} z \cos\theta} \fsd \theta +
\int_0^{\pi} -\cos(n_+\theta) \mathrm{e}^{-\mathrm{j} z \cos\theta} \fsd \theta
...
J_{n_+}(z) \frac{\pi}{\im^{-n_+}} - J_{n_+}(-z) \frac{\pi}{\im^{-n_+}}
\end{align}
Combining both cosine With prefactor yields
\begin{align}
\frac{1}{2}
\e^{- \im m \phi_{PW}}
[
...
\end{align}
with $J_n(z) = (-1)^n J_n(-z)$
\begin{align}
\frac{1}{2}
\e^{- \im m \phi_{PW}}
[
(-1)^{n_-} J_{n_-}(-z) \frac{\pi}{\im^{-n_-}} - J_{n_-}(-z) \frac{\pi}{\im^{-n_-}} + 
(-1)^{n_+} J_{n_+}(-z) \frac{\pi}{\im^{-n_+}} - J_{n_+}(-z) \frac{\pi}{\im^{-n_+}}
]
\end{align}
inserting var
...
\e^{- \im m \phi_{PW}}
[
(-1)^{(-m+1)} J_{(-m+1)}(\frac{\omega}{c} r_0) \frac{\pi}{\im^{-(-m+1)}} - J_{(-m+1)}(\frac{\omega}{c} r_0) \frac{\pi}{\im^{-(-m+1)}} + \\
(-1)^{(-m-1)} J_{(-m-1)}(\frac{\omega}{c} r_0) \frac{\pi}{\im^{-(-m-1)}} - J_{(-m-1)}(\frac{\omega}{c} r_0) \frac{\pi}{\im^{-(-m-1)}}
]
\end{align}
since $-\infty\leq m \leq +\infty$ in the Fourier series we can $-m\rightarrow +m$
\begin{align}
\frac{1}{2}
\e^{+ \im m \phi_{PW}}
[
...
\end{align}
bring $\im^{-(m)}$ and $\pi$ out
\begin{align}
\frac{\pi\,\e^{+ \im m \phi_{PW}}}{2\,\im^{-m}}
[
(-1)^{(m+1)} J_{m+1}(\frac{\omega}{c} r_0) \frac{1}{\im^{-1}} - J_{m+1}(\frac{\omega}{c} r_0) \frac{1}{\im^{-1}} + \\
(-1)^{(m-1)} J_{m-1}(\frac{\omega}{c} r_0) \frac{1}{\im^{+1}} - J_{m-1}(\frac{\omega}{c} r_0) \frac{1}{\im^{+1}}
]
\end{align}
\begin{align}
\frac{\pi\,\e^{+ \im m \phi_{PW}}}{2\,\im^{-m}}
[
(-1)^{(m+1)} J_{m+1}(\frac{\omega}{c} r_0) \im + J_{m+1}(\frac{\omega}{c} r_0) \im - \\
(-1)^{(m-1)} J_{m-1}(\frac{\omega}{c} r_0) \im + J_{m-1}(\frac{\omega}{c} r_0) \im
]
\end{align}
\begin{align}
\frac{\im\,\pi\,\e^{+ \im m \phi_{PW}}}{2\,\im^{-m}}
[
(-1)^{(m+1)} J_{m+1}(\frac{\omega}{c} r_0) + J_{m+1}(\frac{\omega}{c} r_0)  - \\
(-1)^{(m-1)} J_{m-1}(\frac{\omega}{c} r_0) + J_{m-1}(\frac{\omega}{c} r_0) 
]
\end{align}
\begin{align}
\frac{\im^{m+1}\,\pi\,\e^{+ \im m \phi_{PW}}}{2}
[
(-1)^{(m+1)} J_{m+1}(\frac{\omega}{c} r_0) + J_{m+1}(\frac{\omega}{c} r_0)  - \\
(-1)^{(m-1)} J_{m-1}(\frac{\omega}{c} r_0) + J_{m-1}(\frac{\omega}{c} r_0) 
]
...
\frac{\im^{m+1}\,\pi\,\e^{+ \im m \phi_{PW}}}{2}
[
\left(1+(-1)^{(m+1)}\right) J_{m+1}(\frac{\omega}{c} r_0)+
\left(1-(-1)^{(m-1)}\right) J_{m-1}(\frac{\omega}{c} r_0) 
]
\end{align}
